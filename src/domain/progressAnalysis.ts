...
export function calculateProgressStats(data: Record<string, SubjectData>): ProgressStats {
...
export function calculateSemesterAverages(data: Record<string, SubjectData>): SemesterAverage[] {

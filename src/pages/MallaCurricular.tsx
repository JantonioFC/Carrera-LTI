  ...
  return (
    <div className="p-6 space-y-5 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-0.5">Licenciatura en Tecnologías de la Información — Plan 2024</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="col-span-1 card p-4 space-y-3">
          <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Progreso total</p>
          <div className="flex items-end gap-2">
            <span className="text-3xl font-bold text-gradient">{pct}%</span>
          </div>
          <div className="space-y-1">
            <div className="flex justify-between text-xs text-slate-400">
              <span>{creditsDone} / {TOTAL_CREDITS} cr</span>
            </div>
            <div className="h-2 bg-navy-900 rounded-full overflow-hidden">
              <div className="h-full gradient-blue rounded-full transition-all duration-500" style={{ width: `${pct}%` }} />
            </div>
            <div className="flex justify-between text-[10px] text-slate-600">
              <span>Inicio</span><span>Tec.</span><span>Lic.</span>
            </div>
          </div>
        </div>
      ...
      <div className="card p-4">
        <div className="flex items-center justify-between mb-2">
          <p className="text-sm font-medium text-white">★ Titulación intermedia — Tecnicatura (Semestres 1-4)</p>
          <span className="text-sm font-bold text-yellow-400">{tcDone} / {tcTotal} cr</span>
        </div>
      ...
      <div className="overflow-auto border border-navy-700/40 rounded-xl" style={{ maxHeight: 'calc(100vh - 320px)' }}>
                  ...
                  {sem.subjects.map((baseSubject) => {
                    ...
                    return (
                      ...
                      <div className="flex items-center justify-between mt-1.5 ml-2.5">
                        <span className="font-bold">{subject.credits} cr</span>

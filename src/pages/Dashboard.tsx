						...
						<div className="card p-5 space-y-4 border-t-2 border-lti-blue/30 overflow-hidden relative">
									...
									Object.entries(data)
										...
										.map(([id, _d]) => {
											...
											return (
												<div
													key={id}
													className="flex items-center justify-between p-3 bg-navy-900/40 rounded-xl border border-navy-700/30 group hover:border-lti-blue/30 transition-all"
												>
													<div className="flex items-center gap-3">
														...
														<div>
															...
															<p className="text-[10px] text-slate-500 font-mono">
																/mnt/nexus/knowledge/{id}
															</p>
														</div>
													</div>
													<div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
														<button className="p-1.5 hover:bg-navy-800 rounded text-slate-400">
															<History size={12} />
														</button>
														<button className="p-1.5 hover:bg-navy-800 rounded text-slate-400">
							...
							<div className="flex items-center gap-2 pt-2">
								...
								<p className="text-[10px] text-slate-500 font-medium">
									Grafo de sincronización activo y sincronizado
								</p>
							</div>
						</div>
					</div>
